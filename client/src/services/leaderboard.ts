...
export const leaderboardApi = {
  ...
  async individual(studentId: string) {
    ...
    return {
      data: {
        data: {
          studentId: String(stats.student.id),
          studentName: stats.student.name,
          totalPositive: stats.total_positive,
          totalNegative: stats.total_negative,
