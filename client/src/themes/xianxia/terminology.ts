...
export const TERMINOLOGY_MAP: Record<string, TermEntry> = {
  ...
  selectAll: { default: '全选', xianxia: '全选' },
  selectAllVisible: { default: '全选可见', xianxia: '选可见' },
  clearSelection: { default: '清空', xianxia: '清空' },
  exitMultiSelect: { default: '退出多选', xianxia: '退出点选' },
  searchPlaceholder: { default: '搜索姓名 / 拼音 / 首字母', xianxia: '搜索道名 / 道号' },
  clearSearch: { default: '清空搜索', xianxia: '清空搜索' },
  noSearchResults: { default: '没有匹配的学生', xianxia: '无匹配道友' },
